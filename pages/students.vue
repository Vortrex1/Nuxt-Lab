...
export default {
  ...
  mounted() {
    ...
    this.students = [
      ...
      { id: 1, firstName: 'Олександр', lastName: 'Мосійчук', group: 'КН-21' },
      { id: 2, firstName: 'Михайло', lastName: 'Лук’янчук', group: 'КН-22' },
      { id: 2, firstName: 'Назарій', lastName: 'Теренчук', group: 'КН-22' },
      { id: 1, firstName: 'Владислав', lastName: 'Пухалський', group: 'КН-22' },
      { id: 2, firstName: 'Ірина', lastName: 'Гнатюк', group: 'КН-22' },
      { id: 2, firstName: 'Андрій', lastName: 'Лавренюк', group: 'КН-21' },
    ];
  }
};
</script>
